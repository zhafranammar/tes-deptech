                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('extracurriculars.update', $extracurricular->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="extracurricular_name" id="extracurricular_name" class="border p-2 w-full" value="{{ $extracurricular->extracurricular_name }}" required>
                        </div>

                        <!-- Tahun Mulai -->
                        <div class="mb-4">
                            <label for="start_year" class="block">Tahun Mulai:</label>
                            <input type="number" name="start_year" id="start_year" class="border p-2 w-full" value="{{ $extracurricular->start_year }}" required>
                        </div>
